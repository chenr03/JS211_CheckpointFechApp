    ...
    fetch('https://disc-golf.p.rapidapi.com/all', options)
        ...
        .then(arrayOfDiscs => {
            ...
            // - Very Overstable Discs in expert, novice, and beginner categories
                ...
                const expertDiscVeryOverstable = veryOverstable.filter(disc => disc.flightPath.length).filter(disc=> disc.speed >= 11 && disc.glide >= 3 && disc.turn >= 0 && disc.fade >= 4).splice(0, 15)
                const noviceDiscVeryOverstable = veryOverstable.filter(disc => disc.flightPath.length).filter(disc=> (disc.speed < 11 && disc.speed > 5) && disc.glide > 0 && disc.turn >0 && disc.fade >= 0).splice(0, 15)
                const beginnerDiscVeryOverstable = veryOverstable.filter(disc => disc.flightPath.length).filter(disc=> disc.speed <= 5 && disc.glide >= 0 && disc.turn >= 0 && disc.fade>0).splice(0, 15)
            ...
            // - Overstable Discs in expert, novice, and beginner categories
                const expertDiscOverstable = overstable.filter(disc => disc.flightPath.length).filter(disc=> disc.speed >= 11 && disc.glide >= 3 && disc.turn >= 0 && disc.fade >= 4).splice(0, 15)
                const noviceDiscOverstable = overstable.filter(disc => disc.flightPath.length).filter(disc=> (disc.speed < 11 && disc.speed > 5) && disc.glide > 0 && disc.turn >0 && disc.fade >= 0).splice(0, 15)
                const beginnerDiscOverstable = overstable.filter(disc => disc.flightPath.length).filter(disc=> disc.speed <= 5 && disc.glide >= 0 && disc.turn >= 0 && disc.fade>0).splice(0, 15)
            ...
            // - Stable Discs in expert, novice, and beginner categories
                const expertDiscStable = stable.filter(disc => disc.flightPath.length).filter(disc=> disc.speed >= 10 && disc.glide >= 5 && disc.turn >= -3 && disc.fade >= 3).splice(0, 15)
                const noviceDiscStable = stable.filter(disc => disc.flightPath.length).filter(disc=> (disc.speed < 10 && disc.speed >= 6) && disc.glide > 4 && disc.turn > -.5 && disc.fade >= 0).splice(0, 15)
                const beginnerDiscStable = stable.filter(disc => disc.flightPath.length).filter(disc=> disc.speed <= 5 && disc.glide >= -1 && disc.turn >= 0 && disc.fade >= 0).splice(0, 15)
            ...
            // - Understable Discs in expert, novice, and beginner categories
                const expertDiscUnderstable = understable.filter(disc => disc.flightPath.length).filter(disc=> disc.speed >= 10 && disc.glide >= 5 && disc.turn >= -3 && disc.fade >= 3).splice(0, 15)
                const noviceDiscUnderstable = understable.filter(disc => disc.flightPath.length).filter(disc=> (disc.speed < 10 && disc.speed >= 8) && disc.glide > 3 && disc.turn > -5 && disc.fade >= 0).splice(0, 15)
                const beginnerDiscUnderstable = understable.filter(disc => disc.flightPath.length).filter(disc=> disc.speed <= 5 && disc.glide >= -3 && disc.turn >= 0 && disc.fade >= 0).splice(0, 15)
            ...
            // - Very Understable Discs in expert, novice, and beginner categories
                const expertDiscVeryUnderstable = veryUnderstable.filter(disc => disc.flightPath.length).filter(disc=> disc.speed >= 10 && disc.glide >= 3 && disc.turn >= -4 && disc.fade >= 0).splice(0, 15)
                const noviceDiscVeryUnderstable = veryUnderstable.filter(disc => disc.flightPath.length).filter(disc=> (disc.speed < 10 && disc.speed >= 7) && disc.glide > 3 && disc.turn >= -4 && disc.fade >= 0).splice(0, 15)
                const beginnerDiscVeryUnderstable = veryUnderstable.filter(disc => disc.flightPath.length).filter(disc=> disc.speed <= 5 && disc.glide >= 3 && disc.turn >= -4 && disc.fade >= 0).splice(0, 15)
